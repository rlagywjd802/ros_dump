...
ImagePublisher::ImagePublisher(): it_(nh_), test_images(), test_labels()
{
	image_pub_ = it_.advertise("/digit_image", 1);
	load_mnist_img(test_images);
	load_mnist_lbl(test_labels);
	sort_mnist_img(test_images_sorted);
}

void ImagePublisher::keyLoop()
{
	char c;
...
void ImagePublisher::publishDigit(int num)
{
...
int ImagePublisher::convert_to_int(int i)
{
...
void ImagePublisher::load_mnist_img(vector<cv::Mat> &vec)
{
	ifstream file ("/home/hyojeong/catkin_ws/src/mnist_publisher/dataset/t10k-images-idx3-ubyte", ios::binary);
	int magic_number = 0;
...
void ImagePublisher::load_mnist_lbl(vector<double> &vec)
{
	ifstream file ("/home/hyojeong/catkin_ws/src/mnist_publisher/dataset/t10k-labels-idx1-ubyte", ios::binary);
	int magic_number = 0;
	int number_of_images = 0;
...
void ImagePublisher::sort_mnist_img(vector<vector <cv::Mat> > &vec)
{
	for(int i=0; i<=9; i++)
	{
		vector<cv::Mat> temp;
...
int ImagePublisher::get_random_number(int num)
{

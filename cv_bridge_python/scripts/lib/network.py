...
class TwoLayerNet:
    ...
    def save_network(self):
        self.saver.save(self.session, "network/two_layer")
        self.write_weight("weight/w1.txt", self.W1.eval())
        self.write_bias("weight/b1.txt", self.b1.eval())
        self.write_weight("weight/w2.txt", self.W2.eval())
        self.write_bias("weight/b2.txt", self.b2.eval())

    def restore_network(self):
        self.saver.restore(self.session, "network/two_layer")
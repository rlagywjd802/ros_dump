...
def load_mnist(path = ".", normalize=False, flatten=True, one_hot_label=True):
    """
    ...
    # train_data = np.concatenate((dataset['train_img'], dataset['train_lbl']), axis=1)
    # test_data = np.concatenate((dataset['test_img'], dataset['test_lbl']), axis=1)
